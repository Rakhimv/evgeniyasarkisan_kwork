    ...
    return (
        <section className="py-12 px-6 bg-[#EDF6FA] w-full">
            <div className="flex flex-col-reverse xs658:flex-row gap-[50px]">
                <img src="/media/stat.png" className="min-w-[45%] object-cover" />
                ...
                <div className="flex flex-col w-full">
                    ...
                    <div className="w-full flex flex-col items-center xs658:items-start">
                        <p className="txp text-[6vw] xs658:text-2xl xs850:text-3xl xs1000:text-4xl xs1350:text-[45px] font-bold mt-[10px] xs658:mt-[40px] text-center xs658:text-start ">Что изменится после работы со мной?</p>

                        <ul className="uppercase mt-[10px]  text-[4.2vw] xs658:text-lg xs850:text-xl xs1000:text-2xl xs1350:text-3xl txs list-disc ml-[15px] bb2 font-thin! w-max">
