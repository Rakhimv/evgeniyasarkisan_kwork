    ...
    return (
        <section className="relative py-8 px-6 bg-white text-center bgtwo">
            ...
            <div className="flex flex-col xs850:max-w-[60%] xs1350:max-w-none">
                ...
                <div className="max-w-[60%] xs750:max-w-[93%] xs1350:max-w-[40%] mt-[5%] ml-[2%] xs1350:ml-[7%] flex items-start gap-4">
                    <div className="min-w-[5px] bg-[#2E5943] self-stretch"></div>
                    <h1 className="text-xl xs750:text-2xl xs1350:text-3xl text-[#475763] text-left uppercase bb2">
            ...
            <div className="ml-[2%] xs1350:ml-[5%] max-w-[300px] mt-[30px]">
                <ActionButton
                    openTg
                    icon="/media/tg.svg" text="Подписаться на канал" />
            </div>


            <div className="absolute right-[-10%] w-[60%] bottom-[20%] justify-end items-end mt-[40px] mr-[-32px] mb-[-24px] xs550:mr-auto xs550:mb-auto xs550:absolute xs550:right-0 xs550:w-[50%] xs750:w-[30%] xs550:bottom-0 xs1350:hidden">
                <img src="/media/tghead.png" className="w-full" />
            </div>
