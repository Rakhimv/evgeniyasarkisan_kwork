        ...
        <section className="py-12 px-6 bg-[#EDF6FA] w-full">
            ...
            <div className="flex gap-[10px] items-end justify-between px-[5%]">
                <div className="flex gap-[5px]" >
                    ...
                    <h2 className="text-4xl font-bold uppercase txp">Чем я отличаюсь? </h2>
                </div>
                <h2 className="text-4xl font-bold uppercase txs">Почему мне доверяют <span className="txp text-6xl">300+</span> компаний?</h2>
            </div>

            <div className="grid grid-cols-3 gap-[20px] mt-[30px]">
                {advantages.map((item, index) => (
                    <div key={index} className="flex flex-col gap-[10px]">
                        <img src={`/a${index + 1}.png`} alt="" className="w-full h-[250px] object-cover" />
